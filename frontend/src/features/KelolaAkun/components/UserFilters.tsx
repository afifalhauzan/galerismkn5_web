      ...
      <div className="mb-4">
        <div className="relative max-w-md">
          <input
            ...
            className="w-full px-4 py-3 pl-10 pr-10 text-slate-800 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          />
      ...
      <div className="flex flex-wrap gap-4 items-center">
        ...
        <div className="relative">
          <select
            ...
            className="appearance-none bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg border-0 cursor-pointer transition-colors min-w-[120px] text-sm font-medium pr-10"
          >
        ...
        <div className="relative">
          <select
            ...
            className="appearance-none bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg border-0 cursor-pointer transition-colors min-w-[150px] text-sm font-medium pr-10"
          >
