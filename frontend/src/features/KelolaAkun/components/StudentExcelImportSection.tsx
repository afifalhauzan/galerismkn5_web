...
interface StudentExcelImportSectionProps {
...
export default function StudentExcelImportSection({
    selectedFile,
    importStatus,
    isImporting,
    isDownloading,
    ...
    onImportExcel,
    onDownloadTemplate,
}: StudentExcelImportSectionProps) {
    const [isExpanded, setIsExpanded] = useState(false);
    // Collapsible to reduce cognitive load for teachers who may not need this feature often
