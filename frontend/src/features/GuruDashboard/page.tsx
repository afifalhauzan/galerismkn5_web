                            ...
                            <div>
                                ...
                                <div className="mt-1">
                                    {user.jurusans && user.jurusans.length > 0 ? (
                                        ...
                                        <p className="text-sm text-gray-900">{user.jurusan?.nama || 'Jurusan tidak ditemukan'}</p>
                                    )}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white shadow rounded-lg mt-6">
                        ...
                        <div className="px-6 py-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                <Link 
                                    href={user.jurusan_ids && user.jurusan_ids.length > 0 
                                        ? `/galeri?jurusan_ids=${user.jurusan_ids.join(',')}` 
                                        : `/galeri?jurusan_id=${user.jurusan_id}`
                                    }
                                    ...
                                    <div className="ml-3 text-left">
                                        ...
                                        <p className="text-xs text-gray-500">
                                            {user.jurusan_ids && user.jurusan_ids.length > 1 
                                                ? 'Lihat karya siswa dari semua jurusan Anda' 
                                                : 'Lihat karya siswa jurusan Anda'
                                            }
                                        </p>
                                    </div>
                                </Link>
