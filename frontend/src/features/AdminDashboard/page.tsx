                        ...
                        <div className="px-6 py-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <Link 
                                    ...
                                    <div className="ml-3 text-left">
                                        <p className="text-sm font-medium text-gray-900">Kelola Gambar Halaman Utama</p>
                                        <p className="text-xs text-gray-500">Atur carousel dan gambar hero</p>
                                    </div>
                                </Link>
                            </div>
                        </div>
